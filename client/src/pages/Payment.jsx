...
const Payment = () => {
  ...
  return (
    <div className="relative flex-grow bg-gray-100 flex flex-col justify-between">
      ...
      {/* style bg image*/}
      <div className="absolute top-0 w-full h-[50vh] bg-cover bg-center " style={{ backgroundImage: `url(${eventData.imageURI})`, backgroundSize: 600, filter: 'blur(13px)' }}></div>
      ...
      <div className="pt-[45vh] container mx-auto px-4 flex-grow">
        <Box style={{ position: 'relative', marginTop: -200, marginBottom: '50px', display: 'flex' }}>
          <img src={eventData.imageURI} alt={eventData.name} style={{ height: '290px', marginRight: '20px', borderRadius: '10px', marginLeft: '20px' }} />
          <Typography variant="h6" style={{ flexGrow: 1, fontFamily: 'Georgia, serif', color: 'white', marginLeft: '20px', }}>
            <br />
            <span style={{ fontWeight: 'bold', fontSize: '30px' }}>{eventData.name}</span><br />
